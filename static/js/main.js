...
(function($) {
    ...
    $('nav.main-navigation').meanmenu({
        meanMenuClose: '<img class="black" src="static/img/icons/icon-close.png" alt="close icon"><img class="white" src="static/img/icons/icon-close-white.png" alt="close icon">',
